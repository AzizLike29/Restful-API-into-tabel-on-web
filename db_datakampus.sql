...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Mar 2023 pada 05.10
...
INSERT INTO `tb_kampus` (`id`, `nama_kampus`, `daerah`, `jumlah_mahasiswa`) VALUES
(1, 'universitas gadjah mada', 'Yogyakarta', 9000000),
(2, 'universitas pelita bangsa', 'Cikarang', 7000000),
(3, 'universitas gunadarma', 'Depok', 10000000),
(4, 'universitas singaperbangsa', 'Karawang', 6000000),
(5, 'universitas indonesia', 'Depok', 12000000);
